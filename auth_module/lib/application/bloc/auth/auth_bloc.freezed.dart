...
class AuthCheckInit implements AuthEvent {
  const AuthCheckInit();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthCheckInit);
}
...
@override
String toString() {
  return 'AuthState.autenticated(user: $user)';
}
