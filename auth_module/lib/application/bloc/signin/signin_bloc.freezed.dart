...
mixin _$SigninState {
 ...
 EmailAddresse get email; Passwort get password; bool get showErrorMessage; bool get isSubmitting; Option<Either<AuthFailure, Unit>> get authFailureOrSuccessOption;
...
@useResult
$Res call({
 EmailAddresse email, Passwort password, bool showErrorMessage, bool isSubmitting, Option<Either<AuthFailure, Unit>> authFailureOrSuccessOption
});
...
as EmailAddresse,password: null == password ? _self.password : password // ignore: cast_nullable_to_non_nullable
as Passwort,showErrorMessage: null == showErrorMessage ? _self.showErrorMessage : showErrorMessage // ignore: cast_nullable_to_non_nullable
...
@override final  EmailAddresse email;
@override final  Passwort password;
